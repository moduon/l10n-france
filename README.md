...
[l10n_fr_account_vat_return](l10n_fr_account_vat_return/) | 16.0.5.3.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | VAT return for France: CA3, 3310-A, 3519
